...
af = qtd.rank_allele_effects(meta, triplet_qtl, alleles, allele_effects)
...
with open('columns_for_hapmap.json', 'w') as f:
    json.dump(cols_for_hapmap, f)
